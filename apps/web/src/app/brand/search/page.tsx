  ...
  return (
    <div className="animate-fade-in">
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>🔍 Search Creators</h1>
        <p className={styles.pageSubtitle}>Find the perfect creators for your brand campaigns</p>
      </div>
      ...
      <div className="glass-card" style={{ padding: "var(--space-lg)", marginBottom: "var(--space-xl)", display: "flex", gap: "var(--space-sm)" }}>
        <input
          ...
          className="input"
          style={{ flex: 1 }}
          placeholder="Try: 'fitness creator in London' or 'food influencer with 200K+ followers'"
          value={query}
        ...
        {filtered.map((creator, i) => (
          <div key={creator.id} className="glass-card" style={{
            ...
            <div style={{ display: "flex", gap: "var(--space-sm)" }}>
              <button className="btn btn-primary btn-sm" style={{ flex: 1 }}>📩 Send Offer</button>
